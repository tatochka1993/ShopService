 ...
 * 
 */
@WebServiceClient(name = "PriceDatabaseService", targetNamespace = "http://impl.webservice.finalproject/", wsdlLocation = "http://localhost:9999/ws/priceService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PRICEDATABASESERVICE_QNAME = new QName("http://impl.webservice.finalproject/", "PriceDatabaseService");
    ...
    public PriceDatabase getPriceDatabasePort() {
        return super.getPort(new QName("http://impl.webservice.finalproject/", "PriceDatabasePort"), PriceDatabase.class);
    }
    ...
    public PriceDatabase getPriceDatabasePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.webservice.finalproject/", "PriceDatabasePort"), PriceDatabase.class, features);
    }
